...
export async function requireSysAdmin(request, reply) {
...
export function getTenantScope(request) {
    if (!request.user) {
        return null;
    }
...
export function withTenantScope(request, where = {}) {
...
export function getCompanyScope(request) {
    if (!request.user) {
        return null;
    }
...
export function withCompanyScope(request, where = {}) {
