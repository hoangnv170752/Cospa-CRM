...
export async function userRoutes(fastify: FastifyInstance) {
  ...
  fastify.get<{ Querystring: PaginationQuery }>(
    ...
    async (request, reply) => {
      ...
      let where: Record<string, unknown> = withTenantScope(request);
  ...
  fastify.post<{ Body: UserBody }>(
    ...
    async (request, reply) => {
      ...
      let userRole: UserRole = role || 'tenant_user';
  ...
  fastify.put<{ Params: UserParams; Body: Partial<UserBody> & { status?: UserStatus } }>(
    '/users/:id',
    {
      schema: {
        tags: ['Users'],
  ...
  fastify.put<{ Params: UserParams; Body: PermissionBody }>(
